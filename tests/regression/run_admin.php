...
$tests = ['content_admin_security.php', 'content_workspace_dashboard.php', 'ai_field_review.php', 'duplicate_review_ui.php', 'tmdb_review_ui.php', 'final_publication_ui.php'];
