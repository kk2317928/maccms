...
class ApiV1Bootstrap
{
    public static function resolve(array $server)
    {
        ...
        elseif ($path === '/api/v1/site-config') { $target = '/v1.site_config/index'; }
        elseif ($path === '/api/v1/import/videos') { $target = '/v1.import/videos'; $allowed = array('POST'); }
        ...
        elseif (preg_match('#\A/api/v1/people/([A-Z0-9]{6})\z#D', $path, $matches)) { $target = '/v1.people/detail/slug/'.$matches[1]; }
