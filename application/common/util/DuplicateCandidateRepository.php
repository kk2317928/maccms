...
class DuplicateCandidateRepository
{
    ...
    public function record(int $firstVodId, int $secondVodId, int $score, array $evidence): int
    {
        ...
        return $this->persist([
            'vod_id_low' => min($firstVodId, $secondVodId),
            'vod_id_high' => max($firstVodId, $secondVodId),
